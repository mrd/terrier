...
fun fixedslot_readptr {a:t@ype} {l: agz} (!a @ l | !fixedslot >> fixedslot, ptr l, size_t (sizeof a)): void
fun fixedslot_writeptr {a:t@ype} {l: agz} (!a @ l | !fixedslot >> fixedslot, ptr l, size_t (sizeof a)): void
