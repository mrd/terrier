...
// fun{a:t@ype} multireader_initialize_reader {l:addr | l > null} {n: nat} (
...
fun{a:t@ype} multireader_initialize_writer {l:addr | l > null} {n: nat} (
    pf: ipcmem_v (l, n) | p: ptr l, pages: int n
  ): [s: int]
     [overlap': bool]
...
prfun multireader_release {l:addr} {n,i:nat} {a:t@ype} {w:bool} (_: mslot_v (l, n, a, w, i)): ipcmem_v (l, n)
prfun multireader_release_ws3_v {OP, IP, Rip, Wip: bit} {overlap: bool} (_: ws3_v (OP, IP, Rip, Wip, overlap)): void

// fun{a:t@ype} multireader_read {l: addr} {n, i: nat} (pf_ms: !mslot_v (l, n, a, false) | ms: ptr l): a
fun{a:t@ype} multireader_read {l: addr} {n, i: nat} (pf_ms: !mslot_v (l, n, a, false, i) | ms: ptr l, i: int i): a

fun{a:t@ype} multireader_write {l: addr} {n: nat}
